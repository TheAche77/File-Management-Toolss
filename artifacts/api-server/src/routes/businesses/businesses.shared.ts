...
export function serializeBusiness(r: Record<string, unknown>) {
  return {
    ...
    geonamesId: r["geonamesId"] ?? null,
    opencorporatesId: r["opencorporatesId"] ?? null,
    ...
    enrichmentSourceCount: r["enrichmentSourceCount"] ?? null,
    lastEnrichmentAt: (r["lastEnrichmentAt"] as Date | null | undefined)?.toISOString() ?? null,
